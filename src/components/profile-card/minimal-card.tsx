// components/profile-card/minimal-card.tsx
...
const MinimalCard = ({
  ...
  return (
    <BackgroundGradient containerClassName="max-w-sm mx-auto">
      <Card className="relative max-w-sm mx-auto bg-gradient-to-b text-white bg-neutral-800 rounded-3xl shadow-xl">
        <BackgroundBeamsWithCollision>
          ...
          <CardContent className="p-6 space-y-6">
            ...
            <Button className="w-full bg-gradient-to-r from-yellow-300 via-white to-lime-300 text-black font-bold shadow-lg">
